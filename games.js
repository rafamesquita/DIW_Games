...
function atualizaJogos(qntGames) {
  fetch('https://api.rawg.io/api/games?key=dd4eae6aa9fd4ddcad700312af7c4076&page_size=10')
    .then(res => res.json())
    .then(data => {
      let str = '';
...
function atualizaPlataformas(qntPlataformas) {
  fetch('https://api.rawg.io/api/platforms?key=dd4eae6aa9fd4ddcad700312af7c4076&page_size=10')
    .then(res => res.json())
    .then(data => {
      let str1 = '';
